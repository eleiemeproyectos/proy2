...
public final class CeeDee {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      ...
      B=$fix($opIntvlY('0','9'));
      $line=32;
      Object coder=$fix($invokeMethod(CeeDee.class,"createCoder",true,null,new Object[]{}));
      $line=33;
      Object deCoder=$fix($invokeMethod(CeeDee.class,"createDecoder",true,null,new Object[]{}));
      $line=40;
            ...
            if (($opEqualY($opAbsolY(state),2)&&$opEqualY(input,':'))) {
              ...
              if (($opEqualY($opAbsolY(state),3)&&$opMembrY(input,$opIntvlY('a','z')))) {
                ...
                if (($opEqualY(0,pos)&&$opEqualY(input,s))) {
                  ...
                  if ($opEqualY(pos,1)) {
                    $line=91;
                    $result=$invokeMethod(CeeDee.class,"shiftSymbol",true,null,new Object[]{input,d});
                    if (true) break $try;
                  }
                  else {
                    $line=92;
      ...
      if (($opEqualY(pos,"_")&&$opEqualY(input,':'))) {
        ...
        if (($opEqualY(input,'#')&&$opEqualY(pos,0))) {
          ...
          if (($opMembrY(input,$opIntvlY('a','z'))&&$opEqualY(pos,1))) {
            $line=150;
            $result=$invokeMethod(CeeDee.class,"shiftSymbol",true,null,new Object[]{input,$opMinusY(d)});
            if (true) break $try;
          }
          else {
            $line=151;
